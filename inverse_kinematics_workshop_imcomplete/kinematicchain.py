...
class KinematicChain:
	...
	def compute_htms(self):
		...
		"""
		#TODO:  Implement a function that computes the HTM for each link in the chain.
			Implement as a 3-D tensor of dimension [n_links+1 x 4 x 4], where output[i]
			is the transform to the i-th link (out[0] is the transform from origin to origin).
		"""
		pass
	def end_effector_position(self):
		...
		"""
		TODO: Implement this function to output a 3x1 array containing the end-effector position [x_e, y_e, z_e]
		Hint: Use the compute_htms function to make your life much easier.
		"""
